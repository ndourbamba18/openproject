...
RSpec.describe "API v3 Workspace resource update", content_type: :json do
  ...
  shared_examples_for "update a workspace" do
  ...
  describe "PATCH /api/v3/projects/:id" do
    include_examples "update a workspace" do
  ...
  describe "PATCH /api/v3/workspace/:id" do
    include_examples "update a workspace" do
      let(:path) { api_v3_paths.workspace(project.id) }
    end
  end
end
