  ...
  module ActivitiesTab
    class IndexComponent < ApplicationComponent
      ...
      def list_journals_component
        WorkPackages::ActivitiesTab::Journals::IndexComponent.new(work_package:, journals:, filter:, paginator:)
      end
      ...
      attr_reader :work_package, :journals, :filter, :last_server_timestamp, :paginator
